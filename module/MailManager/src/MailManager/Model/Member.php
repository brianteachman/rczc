...
class Member implements InputFilterAwareInterface
{
    ...
    public function exchangeArray($data)
    {
        ...
        $this->volunteer_interest  = (isset($data['volunteer_interest'])) ? $data['volunteer_interest'] : null;
        $this->current_role  = (isset($data['current_role'])) ? $data['current_role'] : null;
        $this->last_renewal  = (isset($data['last_renewal'])) ? $data['last_renewal'] : null;
