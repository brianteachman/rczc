...
namespace TarotTest\Model;

use Tarot\Model\ReadingInfo;
use PHPUnit_Framework_TestCase;

class ReadingInfoTest extends PHPUnit_Framework_TestCase
{
    ...
    public function testReadingInfoInitialState()
    {
        $info = new ReadingInfo();
